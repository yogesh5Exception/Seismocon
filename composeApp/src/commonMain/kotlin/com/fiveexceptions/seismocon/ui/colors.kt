package com.fiveexceptions.seismocon.ui
...
val Blue2 = Color(0xFF4570A9)
val White30Per = Color.White.copy(alpha = 0.3f)
val White20Per = Color.White.copy(alpha = 0.2f)
val White50Per = Color.White.copy(alpha = 0.5f)
val White10Per = Color.White.copy(alpha = 0.1f)
val Gray = Color(0xFFA0B1C9)
val Gray2 = Color(0xFF5D5C5C)
val GradientDarkBlue = Color(0xFF192E53)
val GradientLightBlue = Color(0xFF6EA4E2)
val GradientRed = Color(0xFFC82D14)
val LightGray = Color(0xFFD9D9D9)
val Green = Color(0xFF0B7939)
val GreenBrighter = Color(0xFF85BC9C)

val DashboardBg = Color(0xFFD4DBE3)

val Blue30 = Color(0x4D364F7D)
