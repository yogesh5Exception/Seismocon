...
@Composable
fun MyObjectReportsAndNotificationScreen(navController: NavController) {
    ...
    val notifications: List<MyObjectNotificationData> = listOf(
        MyObjectNotificationData(
            notificationId = "456446",
            date = "03/03/25",
            isShowingDeleteButton = false, id = 1
        ),
        MyObjectNotificationData(
            notificationId = "456446",
            date = "03/03/25",
            isShowingDeleteButton = true, id = 2
        )
    )
...
//                        navController.navigate(MyObjectReportsAndNotificationScreen)
                ...
                Column(
                    ...
                    Column(
                        ...
                        MyObjectReportItem(
                            ...
                            item = MyObjectReportData("Report ID", "Type", "Date", false, -1),
                            fontWeight = FontWeight.Medium,
                ...
                Column(
                    ...
                    Column(
                        ...
                        MyObjectNotificationItem(
                            modifier = Modifier.fillMaxWidth(),
                            fontFamily = FontFamily(Font(Res.font.inter_medium)),
                            item = MyObjectNotificationData("Notification ID", "Date", false, -1),
                            fontWeight = FontWeight.Medium,
                            textStyle = MaterialTheme.typography.bodyMedium
                        )
